...
var myApp = angular
    ...
    .config(function($routeProvider) {
        $routeProvider
            ...
            .when('/dispute/:dpid', {
                templateUrl: 'views/dispute-detail.html',
...
.filter('avatarUrl', function() {
    return function(owner) {
        ...
        if (owner && owner.image) {
            url = owner.image.cdn ? owner.logo.cdn.secure_url : owner.image.url;
        } else if (owner && owner.logo) {
            url = owner.logo.cdn ? owner.logo.cdn.secure_url : owner.logo.url;
        }
        return url;
    }
});
